...
$rootScope.Styling, $rootScope.Shoot;

$rootScope.getContentType = function(type, orderField){

      Prismic.Api('https://karissawalker.cdn.prismic.io/api', function (err, Api) {
          Api.form('everything')
              .ref(Api.master())
              ...
              .submit(function (err, response) {
                  ...
                  var Data = response;
                  if (type =='styling'){
                    $rootScope.Styling = response.results;
                    console.log($rootScope.Styling);
                    $rootScope.$broadcast('stylingReady');
                    // $rootScope.$apply();
                  }
                  else if (type =='personal'){
                    $rootScope.Personal = response.results;
                    console.log($rootScope.Personal);
                    $rootScope.$broadcast('personalReady');
                    // $rootScope.$apply();
                  }
...
$rootScope.getContentType('styling', 'my.styling.date desc');
